...
#
#  $ bin/test -s prodam.teste -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src prodam.teste.testing.PRODAM_TESTE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/prodam/teste/tests/robot/test_example.robot
#
